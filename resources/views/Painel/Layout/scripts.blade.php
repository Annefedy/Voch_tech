...
{{-- <script src="{{asset('AdminLTE-3.2.0/plugins/chart.js/Chart.v4.3.0.js')}}"></script> --}}
<!-- Sparkline -->
...
<script src="{{ asset('/AdminLTE-3.2.0/plugins/moment/moment-with-locales.min.js') }}"></script>
{{-- <script src="{{ asset('/AdminLTE-3.2.0/plugins/moment/locale/pt-br.js') }}"></script> --}}
