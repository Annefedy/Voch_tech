/*! Summernote v0.7.3 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ ! function(a) {
  ...
  var j = {
      ...
      isMSIE: h,
      isFF: /firefox/i.test(g),
      isWebkit: /webkit/i.test(g),
      isSafari: /safari/i.test(g),
      browserVersion: b,
      jqueryVersion: parseFloat(a.fn.jquery),
      isSupportAmd: e,
      hasCodeMirror: e ? require.specified("codemirror") : !!window.CodeMirror,
      isFontInstalled: f,
    ...
    m = function() {
      var b = function(b) {
        ...
        s = f("TABLE"),
        t = function(a) {
          return !(y(a) || u(a) || v(a) || n(a) || s(a) || x(a))
        },
        u = function(a) {
        ...
        F = j.isMSIE && j.browserVersion < 11 ? "&nbsp;" : "<br>",
        G = function(a) {
    ...
    n = function(b, e) {
      ...
      return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = e, this.initialize = function() {
        ...
        this.code(m.emptyPara), this._destroy(), this._initialize()
        ...
        d.shouldInitialize = d.shouldInitialize || c.ok, d.shouldInitialize() && (d.initialize && d.initialize(), d.events && m.attachEvents(b, d.events))
        ...
        c.shouldInitialize() && (c.events && m.detachEvents(b, c.events), c.destroy && c.destroy()), delete this.modules[a]
  ...
  var o = function(b, c, d, e) {
    ...
    p = {
      create: function(b, c) {
        return function() {
          ...
          return e && e.children && (d = e.children), new o(b, d, e, c)
        }
      }
    },
    q = p.create('<div class="note-editor note-frame panel panel-default"/>'),
    r = p.create('<div class="note-toolbar panel-heading"/>'),
    s = p.create('<div class="note-editing-area"/>'),
    t = p.create('<textarea class="note-codable"/>'),
    u = p.create('<div class="note-editable panel-body" contentEditable="true"/>'),
    v = p.create(['<div class="note-statusbar">', '  <div class="note-resizebar">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', "  </div>", "</div>"].join("")),
    w = p.create('<div class="note-editor"/>'),
    x = p.create('<div class="note-editable" contentEditable="true"/>'),
    y = p.create('<div class="note-btn-group btn-group">'),
    z = p.create('<button type="button" class="note-btn btn btn-default btn-sm">', function(a, b) {
      b && b.tooltip && a.attr({
        title: b.tooltip
      }).tooltip({
        container: "body",
    ...
    A = p.create('<div class="dropdown-menu">', function(b, c) {
    ...
    B = p.create('<div class="dropdown-menu note-check">', function(b, c) {
      var d = a.isArray(c.items) ? c.items.map(function(a) {
        var b = "string" == typeof a ? a : a.value || "",
          d = c.template ? c.template(a) : a;
        return '<li><a href="#" data-value="' + b + '">' + F(c.checkClassName) + " " + d + "</a></li>"
      }).join("") : c.items;
      b.html(d)
    }),
    C = p.create('<div class="note-color-palette"/>', function(a, b) {
    ...
    D = p.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function(a, b) {
    ...
    E = p.create(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""), function(a, b) {
    ...
    G = {
      ...
      createLayout: function(a, b) {
        var c = (b.airMode ? G.airEditor([G.editingArea([G.airEditable()])]) : G.editor([G.toolbar(), G.editingArea([G.codable(), G.editable()]), G.statusbar()])).render();
  ...
  a.extend(a.summernote.lang, {
    "en-US": {
      ...
      image: {
        ...
        url: "Link da imagem",
        remove: "Remover image"
      },
      video: {
        video: "V\u00EDdeo",
        videoLink: "Video Link",
        insert: "Inserir v\u00EDdeo",
        url: "Endere\u00E7o do v\u00EDdeo",
      ...
      paragraph: {
        ...
        justify: "Justificar completo"
      },
      color: {
        recent: "\u00DAltima cor usada",
        more: "Cores",
        background: "Cor de fundo",
        foreground: "Cor principal",
      ...
      help: {
        ...
        tab: "Tabula\u00e7\u00e3o",
        untab: "Remover tabula\u00e7\u00e3o",
        bold: "Negrito",
        italic: "It\u00e1lico",
        underline: "Sublinhado",
        strikethrough: "Riscar",
        removeFormat: "Remover formata\u00e7\u00e3o",
        justifyLeft: "Alinhas a esquerda",
        justifyCenter: "Alinhar ao centro",
        justifyRight: "Alinhar a direita",
        justifyFull: "Alinhar completamente",
        insertUnorderedList: "Alternar lista n\u00e3o ordenada",
        insertOrderedList: "Alternar lista ordenada list",
        outdent: "Recuar no par\u00e1grafo atual",
        indent: "Avan\u00e7ar no par\u00e1grafo atual",
        formatPara: "Header n\u00edvel 0",
        formatH1: "Header n\u00edvel 1",
        formatH2: "Header n\u00edvel 2",
        formatH3: "Header n\u00edvel 3",
        formatH4: "Header n\u00edvel 4",
        formatH5: "Header n\u00edvel 5",
        formatH6: "Header n\u00edvel 6",
        insertHorizontalRule: "Inserir linha horizontal",
        "linkDialog.show": "Inserir link"
      },
      history: {
        undo: "Undo",
        redo: "Redo"
  ...
  var H, I = function() {
    ...
    J = function() {
      var b = function(a, b) {
          ...
          if (0 !== c && m.isText(h[c - 1])) {
            ...
            j.nodeValue;
            b && j.nextSibling && m.isText(j.nextSibling) && l === j.nodeValue.length && (l -= j.nodeValue.length, j = j.nextSibling), f = j, c = l
          }
          return {
            cont: f,
            offset: c
        ...
        e = function(a) {
          var b = function(a, e) {
              var f, g;
              if (m.isText(a)) {
                var h = m.listPrev(a, c.not(m.isText)),
                  i = d.last(h).previousSibling;
                f = i || a.parentNode, e += d.sum(d.tail(h), m.nodeLength), g = !i
              } else {
                if (f = a.childNodes[e] || a, m.isText(f)) return b(f, 0);
                e = 0, g = !1
              }
              return {
                node: f,
        ...
        f = function(b, g, h, i) {
          ...
          this.getPoints = function() {
            ...
            return a[0].scrollTop + a.height() < this.sc.offsetTop && (a[0].scrollTop += Math.abs(a[0].scrollTop + a.height() - this.sc.offsetTop)), this
          }, this.normalize = function() {
            var a = function(a, b) {
                if (m.isVisiblePoint(a) && !m.isEdgePoint(a) || m.isVisiblePoint(a) && m.isRightEdgePoint(a) && !b || m.isVisiblePoint(a) && m.isLeftEdgePoint(a) && b || m.isVisiblePoint(a) && m.isBlock(a.node) && m.isEmpty(a.node)) return a;
                var c = m.ancestor(a.node, m.isBlock);
                if ((m.isLeftEdgePointOf(a, c) || m.isVoid(m.prevPoint(a).node)) && !b || (m.isRightEdgePointOf(a, c) || m.isVoid(m.nextPoint(a).node)) && b) {
                  if (m.isVisiblePoint(a)) return a;
                  b = !b
                }
                var d = b ? m.nextPointUntil(m.nextPoint(a), m.isVisiblePoint) : m.prevPointUntil(m.prevPoint(a), m.isVisiblePoint);
                return d || a
              },
            ...
            var e = b && b.includeAncestor,
              ...
              i = [],
              j = [];
            return m.walkPoint(g, h, function(b) {
              if (!m.isEditable(b.node)) {
                var c;
                f ? (m.isLeftEdgePoint(b) && j.push(b.node), m.isRightEdgePoint(b) && d.contains(j, b.node) && (c = b.node)) : c = e ? m.ancestor(b.node, a) : b.node, c && a(c) && i.push(c)
              }
            }, !0), d.unique(i)
          }, this.commonAncestor = function() {
            return m.commonAncestor(b, h)
          }, this.expand = function(a) {
            var c = m.ancestor(b, a),
              d = m.ancestor(h, a);
            if (!c && !d) return new f(b, g, h, i);
            var e = this.getPoints();
            return c && (e.sc = c, e.so = 0), d && (e.ec = d, e.eo = m.nodeLength(d)), new f(e.sc, e.so, e.ec, e.eo)
          }, this.collapse = function(a) {
            return a ? new f(b, g, b, g) : new f(h, i, h, i)
          }, this.splitText = function() {
            var a = b === h,
              c = this.getPoints();
            return m.isText(h) && !m.isEdgePoint(this.getEndPoint()) && h.splitText(i), m.isText(b) && !m.isEdgePoint(this.getStartPoint()) && (c.sc = b.splitText(g), c.so = 0, a && (c.ec = c.sc, c.eo = i - g)), new f(c.sc, c.so, c.ec, c.eo)
            ...
            var b = this.splitText(),
              ...
              e = m.prevPointUntil(b.getStartPoint(), function(a) {
                return !d.contains(c, a.node)
              }),
              g = [];
            return a.each(c, function(a, b) {
              var c = b.parentNode;
              e.node !== c && 1 === m.nodeLength(c) && g.push(c), m.remove(b, !1)
          ...
          var l = function(a) {
            return function() {
              var c = m.ancestor(b, a);
              return !!c && c === m.ancestor(h, a)
            }
          };
          this.isOnEditable = l(m.isEditable), this.isOnList = l(m.isList), this.isOnAnchor = l(m.isAnchor), this.isOnCell = l(m.isCell), this.isLeftEdgeOf = function(a) {
            if (!m.isLeftEdgePoint(this.getStartPoint())) return !1;
            var b = m.ancestor(this.sc, a);
            return b && m.isLeftEdgeOf(this.sc, b)
          }, this.isCollapsed = function() {
            return b === h && g === i
          }, this.wrapBodyInlineWithPara = function() {
            if (m.isBodyContainer(b) && m.isEmpty(b)) return b.innerHTML = m.emptyPara, new f(b.firstChild, 0, b.firstChild, 0);
            var a = this.normalize();
            if (m.isParaInline(b) || m.isPara(b)) return a;
            var e;
            if (m.isInline(a.sc)) {
              var g = m.listAncestor(a.sc, c.not(m.isInline));
              e = d.last(g), m.isInline(e) || (e = g[g.length - 2] || a.sc.childNodes[a.so])
            } else e = a.sc.childNodes[a.so > 0 ? a.so - 1 : 0];
            var h = m.listPrev(e, m.isParaInline).reverse();
            if (h = h.concat(m.listNext(e.nextSibling, m.isParaInline)), h.length) {
              var i = m.wrap(d.head(h), "p");
              m.appendChildNodes(i, d.tail(h))
            }
            return this.normalize()
          }, this.insertNode = function(a) {
            var b = this.wrapBodyInlineWithPara().deleteContents(),
              c = m.splitPoint(b.getStartPoint(), m.isInline(a));
            ...
            var a = k();
            return j.isW3CRangeSupport ? a.toString() : a.text
          }, this.getWordRange = function(a) {
            var b = this.getEndPoint();
            if (!m.isCharPoint(b)) return this;
            var c = m.prevPointUntil(b, function(a) {
              return !m.isCharPoint(a)
            });
            return a && (b = m.nextPointUntil(b, function(a) {
              return !m.isCharPoint(a)
            })), new f(c.node, c.offset, b.node, b.offset)
          }, this.bookmark = function(a) {
            return {
              s: {
                path: m.makeOffsetPath(a, b),
                offset: g
              },
              e: {
                path: m.makeOffsetPath(a, h),
                offset: i
              }
            }
            ...
            return {
              s: {
                path: d.tail(m.makeOffsetPath(d.head(a), b)),
                offset: g
              },
              e: {
                path: d.tail(m.makeOffsetPath(d.last(a), h)),
                offset: i
              }
            }
      ...
      return {
        create: function(a, c, d, e) {
          if (arguments.length) 2 === arguments.length && (d = a, e = c);
          else if (j.isW3CRangeSupport) {
            var g = document.getSelection();
            if (!g || 0 === g.rangeCount) return null;
            if (m.isBody(g.anchorNode)) return null;
            ...
            var n = b(l, !0),
              o = b(k, !1);
            m.isText(n.node) && m.isLeftEdgePoint(n) && m.isTextNode(o.node) && m.isRightEdgePoint(o) && o.node.nextSibling === n.node && (n = o), a = n.cont, c = n.offset, d = o.cont, e = o.offset
          }
        ...
        createFromNode: function(a) {
          var b = a,
            ...
            d = a,
            e = m.nodeLength(d);
          return m.isVoid(b) && (c = m.listPrev(b).length - 1, b = b.parentNode), m.isBR(d) ? (e = m.listPrev(d).length - 1, d = d.parentNode) : m.isVoid(d) && (e = m.listPrev(d).length, d = d.parentNode), this.create(b, c, d, e)
        },
        ...
        createFromBookmark: function(a, b) {
          var c = m.fromOffsetPath(a, b.s.path),
            d = b.s.offset,
            e = m.fromOffsetPath(a, b.e.path),
            g = b.e.offset;
        ...
        createFromParaBookmark: function(a, b) {
          var c = a.s.offset,
            e = a.e.offset,
            g = m.fromOffsetPath(d.head(b), a.s.path),
            h = m.fromOffsetPath(d.last(b), a.e.path);
    ...
    L = function(a) {
      var b = [],
        ...
        f = function(b) {
          null !== b.contents && a.html(b.contents), null !== b.bookmark && J.createFromBookmark(d, b.bookmark).select()
        };
    ...
    M = function() {
      ...
      this.fromNode = function(a) {
        ...
        if (b.isCollapsed()) return [b.insertNode(m.create(f))];
        var i = m.makePredByNodeName(f),
          j = b.nodes(m.isText, {
            fullyContains: !0
          }).map(function(a) {
            return m.singleChildAncestor(a, i) || m.wrap(a, f)
          });
        if (g) {
          if (h) {
            var k = b.nodes();
          ...
          return j.map(function(b) {
            var c = m.withClosestSiblings(b, i),
              e = d.head(c),
              f = d.tail(c);
            return a.each(f, function(a, b) {
              m.appendChildNodes(e, b.childNodes), m.remove(b)
            }), d.head(c)
          })
        }
        return j
      }, this.current = function(b) {
        var c = a(m.isElement(b.sc) ? b.sc : b.sc.parentNode),
          d = this.fromNode(c);
        try {
          d = a.extend(d, {
        ...
        var h = m.ancestor(b.sc, m.isPara);
        ...
        return d.anchor = b.isOnAnchor() && m.ancestor(b.sc, m.isAnchor), d.ancestors = m.listAncestor(b.sc, m.isEditable), d.range = b, d
      }
    },
    N = function() {
      this.insertOrderedList = function() {
        ...
        var b = this,
          e = J.create().wrapBodyInlineWithPara(),
          f = e.nodes(m.isPara, {
            includeAncestor: !0
          }),
          g = d.clusterBy(f, c.peq2("parentNode"));
        a.each(g, function(c, e) {
          var f = d.head(e);
          m.isLi(f) ? b.wrapList(e, f.parentNode.nodeName) : a.each(e, function(b, c) {
        ...
        a.each(g, function(c, e) {
          var f = d.head(e);
          m.isLi(f) ? b.releaseList([e]) : a.each(e, function(b, c) {
            a(c).css("marginLeft", function(a, b) {
        ...
        var e = this,
          f = J.create().wrapBodyInlineWithPara(),
          g = f.nodes(m.isPara, {
            includeAncestor: !0
          }),
          h = f.paraBookmark(g),
          i = d.clusterBy(g, c.peq2("parentNode"));
        if (d.find(g, m.isPurePara)) {
          var j = [];
          a.each(i, function(a, c) {
            j = j.concat(e.wrapList(c, b))
          }), g = j
        } else {
          var k = f.nodes(m.isList, {
            includeAncestor: !0
          }).filter(function(c) {
            return !a.nodeName(c, b)
          });
          k.length ? a.each(k, function(a, c) {
            m.replace(c, b)
          }) : g = this.releaseList(i, !0)
        }
        J.createFromParaBookmark(h, g).select()
      }, this.wrapList = function(a, b) {
        var c = d.head(a),
          e = d.last(a),
          f = m.isList(c.previousSibling) && c.previousSibling,
          g = m.isList(e.nextSibling) && e.nextSibling,
          h = f || m.insertAfter(m.create(b || "UL"), e);
        return a = a.map(function(a) {
          return m.isPurePara(a) ? m.replace(a, "LI") : a
        }), m.appendChildNodes(h, a), g && (m.appendChildNodes(h, d.from(g.childNodes)), m.remove(g)), a
      }, this.releaseList = function(b, c) {
        var e = [];
        return a.each(b, function(b, f) {
          var g = d.head(f),
            h = d.last(f),
            i = c ? m.lastAncestor(g, m.isList) : g.parentNode,
            j = i.childNodes.length > 1 ? m.splitTree(i, {
              node: h.parentNode,
              offset: m.position(h) + 1
            }, {
          ...
          f = c ? m.listDescendant(k, m.isLi) : d.from(k.childNodes).filter(m.isLi), (c || !m.isList(i.parentNode)) && (f = f.map(function(a) {
            return m.replace(a, "P")
          })), a.each(d.from(f).reverse(), function(a, b) {
            m.insertAfter(b, i)
          });
          var l = d.compact([i, k, j]);
          a.each(l, function(b, c) {
            var d = [c].concat(m.listDescendant(c, m.isList));
            a.each(d.reverse(), function(a, b) {
              m.nodeLength(b) || m.remove(b, !0)
            })
          }), e = e.concat(f)
        }), e
      }
    ...
    O = function() {
      ...
      this.insertTab = function(a, b, c) {
        var d = m.createText(new Array(c + 1).join(m.NBSP_CHAR));
        b = b.deleteContents(), b.insertNode(d, !0), b = J.create(d, c), b.select()
      }, this.insertParagraph = function(c) {
        var d = J.create();
        d = d.deleteContents(), d = d.wrapBodyInlineWithPara();
        var e, f = m.ancestor(d.sc, m.isPara);
        if (f) {
          if (m.isEmpty(f) && m.isLi(f)) return void b.toggleList(f.parentNode.nodeName);
          if (m.isEmpty(f) && m.isPara(f) && m.isBlockquote(f.parentNode)) m.insertAfter(f, f.parentNode), e = f;
          else {
            e = m.splitTree(f, d.getStartPoint());
            var g = m.listDescendant(f, m.isEmptyAnchor);
            g = g.concat(m.listDescendant(e, m.isEmptyAnchor)), a.each(g, function(a, b) {
              m.remove(b)
            }), (m.isHeading(e) || m.isPre(e)) && m.isEmpty(e) && (e = m.replace(e, "p"))
          }
        } else {
          var h = d.sc.childNodes[d.so];
          e = a(m.emptyPara)[0], h ? d.sc.insertBefore(e, h) : d.sc.appendChild(e)
        }
        J.create(e, 0).normalize().select().scrollIntoView(c)
      }
    },
    P = function() {
      this.tab = function(a, b) {
        var c = m.ancestor(a.commonAncestor(), m.isCell),
          e = m.ancestor(c, m.isTable),
          f = m.listDescendant(e, m.isCell),
          g = d[b ? "prev" : "next"](f, c);
        g && J.create(g, 0).select()
      }, this.createTable = function(b, c, d) {
        for (var e, f = [], g = 0; b > g; g++) f.push("<td>" + m.blank + "</td>");
        e = f.join("");
    ...
    R = function(b) {
      ...
      this.initialize = function() {
        g.on("keydown", function(a) {
          a.keyCode === I.code.ENTER && b.triggerEvent("enter", a), b.triggerEvent("keydown", a), h.shortcuts && !a.isDefaultPrevented() && c.handleKeyMap(a)
        }).on("keyup", function(a) {
        ...
        var a = j.isMSIE ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input";
        g.on(a, function() {
        ...
        }), !h.airMode && h.height && g.outerHeight(h.height), !h.airMode && h.maxHeight && g.css("max-height", h.maxHeight), !h.airMode && h.minHeight && g.css("min-height", h.minHeight), g.html(m.html(e) || m.emptyPara), p.recordUndo()
      }, this.destroy = function() {
        g.off()
      }, this.handleKeyMap = function(a) {
        var c = h.keyMap[j.isMac ? "mac" : "pc"],
          d = [];
        a.metaKey && d.push("CMD"), a.ctrlKey && !a.altKey && d.push("CTRL"), a.shiftKey && d.push("SHIFT");
        var e = I.nameFromCode[a.keyCode];
        e && d.push(e);
        var f = c[d.join("+")];
        f ? (a.preventDefault(), b.invoke(f)) : I.isEdit(a.keyCode) && this.afterCommand()
      }, this.createRange = function() {
        return this.focus(), J.create()
      }, this.saveRange = function(a) {
        this.focus(), g.data("range", J.create()), a && J.create().collapse().select()
      }, this.restoreRange = function() {
        var a = g.data("range");
        a && (a.select(), this.focus())
        ...
        var a = J.create();
        return a && (a = a.normalize()), a ? k.current(a) : k.fromNode(g)
      }, this.styleFromNode = function(a) {
        return k.fromNode(a)
      }, this.undo = function() {
        b.triggerEvent("before.command", g.html()), p.undo(), b.triggerEvent("change", g.html())
      }, b.memo("help.undo", i.help.undo), this.redo = function() {
        b.triggerEvent("before.command", g.html()), p.redo(), b.triggerEvent("change", g.html())
      }, b.memo("help.redo", i.help.redo);
      for (var q = this.beforeCommand = function() {
          b.triggerEvent("before.command", g.html()), c.focus()
        }, r = this.afterCommand = function(a) {
          p.recordUndo(), a || b.triggerEvent("change", g.html())
        }, s = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "fontName"], t = 0, u = s.length; u > t; t++) this[s[t]] = function(a) {
        return function(b) {
          q(), document.execCommand(a, !1, b), r(!0)
        }
      }(s[t]), b.memo("help." + s[t], i.help[s[t]]);
      this.tab = function() {
        var a = this.createRange();
        a.isCollapsed() && a.isOnCell() ? l.tab(a) : (q(), n.insertTab(g, a, h.tabSize), r())
        ...
        return K.createImage(a, c).then(function(a) {
          q(), "function" == typeof c ? c(a) : ("string" == typeof c && a.attr("data-filename", c), a.css("width", Math.min(g.width(), a.width())).addClass('img-responsive img-centered')), a.show(), J.create().insertNode(a[0]), J.createFromNodeAfter(a[0]).select(), r()
        }).fail(function() {
        ...
        a.each(d, function(a, d) {
          var e = d.name;
          h.maximumImageFileSize && h.maximumImageFileSize < d.size ? b.triggerEvent("image.upload.error", i.image.maximumFileSizeError) : K.readFileAsDataURL(d).then(function(a) {
        ...
        J.create().insertNode(a), J.createFromNodeAfter(a).select()
      }), this.insertText = this.wrapCommand(function(a) {
        var b = J.create().insertNode(m.createText(a));
        J.create(b, m.nodeLength(b)).select()
      }), this.getSelectedText = function() {
        var a = this.createRange();
        return a.isOnAnchor() && (a = J.createFromNode(m.ancestor(a.sc, m.isAnchor))), a.toString()
      }, this.pasteHTML = this.wrapCommand(function(a) {
        var b = J.create().pasteHTML(a);
        J.createFromNodeAfter(d.last(b)).select()
      }), this.formatBlock = this.wrapCommand(function(a) {
        a = j.isMSIE ? "<" + a + ">" : a, document.execCommand("FormatBlock", !1, a)
      ...
      }(t), b.memo("help.formatH" + t, i.help["formatH" + t]);
      this.fontSize = function(b) {
        this.focus();
        var c = J.create();
        if (c && c.isCollapsed()) {
          var e = k.styleNodes(c),
            f = d.head(e);
          a(e).css({
            "font-size": b + "px"
          }), f && !m.nodeLength(f) && (f.innerHTML = m.ZERO_WIDTH_NBSP_CHAR, J.createFromNodeAfter(f.firstChild).select(), g.data(Q, f))
        } else q(), a(k.styleNodes(c)).css({
          "font-size": b + "px"
        }), r()
      }, this.insertHorizontalRule = this.wrapCommand(function() {
        var b = J.create(),
          c = b.insertNode(a("<HR/>")[0]);
        c.nextSibling && J.create(c.nextSibling, 0).normalize().select()
      }), b.memo("help.insertHorizontalRule", i.help.insertHorizontalRule), this.removeBogus = function() {
        var a = g.data(Q);
        if (a) {
          var b = d.find(d.from(a.childNodes), m.isText),
            c = b.nodeValue.indexOf(m.ZERO_WIDTH_NBSP_CHAR); - 1 !== c && b.deleteData(c, 1), m.isEmpty(a) && m.remove(a), g.removeData(Q)
        }
      }, this.lineHeight = this.wrapCommand(function(a) {
        k.stylePara(J.create(), {
          lineHeight: a
        })
      }), this.unlink = function() {
        var a = this.createRange();
        if (a.isOnAnchor()) {
          var b = m.ancestor(a.sc, m.isAnchor);
          a = J.createFromNode(b), a.select(), q(), document.execCommand("unlink"), r()
        }
        ...
        var j = [];
        if (i) {
          var l = g.insertNode(a("<A>" + e + "</A>")[0]);
          j.push(l)
        } else j = k.styleNodes(g, {
          nodeName: "A",
        ...
        var m = J.createFromNodeBefore(d.head(j)),
          n = m.getStartPoint(),
          o = J.createFromNodeAfter(d.last(j)),
          p = o.getEndPoint();
        J.create(n.node, n.offset, p.node, p.offset).select()
      }), this.getLinkInfo = function() {
        this.focus();
        var b = J.create().expand(m.isAnchor),
          c = a(d.head(b.nodes(m.isAnchor)));
        return {
          range: b,
          text: b.toString(),
        ...
        var b = a.split("x"),
          c = J.create().deleteContents();
        c.insertNode(l.createTable(b[0], b[1], h))
        ...
        this.hasFocus() || (g.focus(), !this.hasFocus() && j.isFF && J.createFromNode(g[0]).normalize().collapse().select())
      }, this.isEmpty = function() {
        return m.isEmpty(g[0]) || m.emptyPara === g.html()
      }, this.empty = function() {
        b.invoke("code", m.emptyPara)
      }
    },
    S = function(b) {
      var c = this,
      ...
      this.events = {
        "summernote.keydown": function(a, d) {
          c.needKeydownHook() && (d.ctrlKey || d.metaKey) && d.keyCode === I.code.V && (b.invoke("editor.saveRange"), c.$paste.focus(), setTimeout(function() {
            c.pasteByHook()
          }, 0))
        }
      }, this.needKeydownHook = function() {
        return j.isMSIE && j.browserVersion > 10 || j.isFF
      }, this.initialize = function() {
  ...
  j.hasCodeMirror && (j.isSupportAmd ? require(["codemirror"], function(a) {
    H = a
  }) : H = window.CodeMirror);
  var U = function(a) {
      ...
      this.sync = function() {
        ...
        a && j.hasCodeMirror && d.data("cmEditor").save()
      }, this.isActivated = function() {
        return b.hasClass("codeview")
      }, this.toggle = function() {
        this.isActivated() ? this.deactivate() : this.activate(), a.triggerEvent("codeview.toggled")
      }, this.activate = function() {
        if (d.val(m.html(c, e.prettifyHtml)), d.height(c.height()), a.invoke("toolbar.updateCodeview", !0), b.addClass("codeview"), d.focus(), j.hasCodeMirror) {
          var f = H.fromTextArea(d[0], e.codemirror);
          if (e.codemirror.tern) {
            var g = new H.TernServer(e.codemirror.tern);
        ...
        var g = m.value(d, e.prettifyHtml) || m.emptyPara,
          h = c.html() !== g;
    ...
    X = function(b) {
      ...
      this.toggle = function() {
        ...
        var i = c.hasClass("fullscreen");
        i ? (e.data("orgHeight", e.css("height")), g.on("resize", function() {
          a({
            h: g.height() - d.outerHeight()
          })
        }).trigger("resize"), h.css("overflow", "hidden")) : (g.off("resize"), a({
          h: e.data("orgHeight")
        }), h.css("overflow", "visible")), b.invoke("toolbar.updateFullscreen", i)
      }
    },
    Y = function(b) {
      var c = this,
    ...
    Z = function(b) {
      ...
      this.events = {
        ...
        if (d.contains([I.code.ENTER, I.code.SPACE], a.keyCode)) {
          var c = b.invoke("editor.createRange").getWordRange();
          this.lastWordRange = c
        }
      }, this.handleKeyup = function(a) {
        d.contains([I.code.ENTER, I.code.SPACE], a.keyCode) && this.replace()
      }
    },
    $ = function(a) {
    ...
    aa = function(b) {
      var e = this,
        ...
        h = b.options,
        i = h.langInfo,
        k = c.invertObject(h.keyMap[j.isMac ? "mac" : "pc"]),
        l = this.representShortcut = function(a) {
          var b = k[a];
          return j.isMac && (b = b.replace("CMD", "?").replace("SHIFT", "?")), b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")"
        };
      this.initialize = function() {
        ...
        b.memo("button.style", function() {
          ...
          return f.button({
            ...
            tooltip: i.font.italic + l("italic"),
          ...
          return f.button({
            ...
            tooltip: i.font.strikethrough + l("strikethrough"),
          ...
          return f.buttonGroup([f.button({
            ...
            items: h.fontNames.filter(function(a) {
              return j.isFontInstalled(a) || d.contains(h.fontNamesIgnoreCheck, a)
            }),
            template: function(a) {
          ...
          return f.buttonGroup({
            ...
            children: [f.button({
              ...
              click: b.createInvokeHandler("editor.color"),
              callback: function(a) {
              ...
              click: function(c) {
                ...
                if (e && f) {
                  var g = "backColor" === e ? "background-color" : "color",
                    ...
                    j = i.data("value");
                  j[e] = f, h.css(g, f), i.data("value", j), b.invoke("editor." + e, f)
                }
              }
            })]
          }).render()
          ...
          return f.button({
            ...
            tooltip: i.lists.unordered + l("insertUnorderedList"),
            click: b.createInvokeHandler("editor.insertUnorderedList")
          }).render()
        }), b.memo("button.ul", function() {
          return f.button({
            contents: f.icon(h.icons.orderedlist),
            tooltip: i.lists.ordered + l("insertOrderedList"),
            click: b.createInvokeHandler("editor.insertOrderedList")
          }).render()
        });
        var g = f.button({
            contents: f.icon(h.icons.alignLeft),
            tooltip: i.paragraph.left + l("justifyLeft"),
            click: b.createInvokeHandler("editor.justifyLeft")
          }),
          k = f.button({
            contents: f.icon(h.icons.alignCenter),
            tooltip: i.paragraph.center + l("justifyCenter"),
            click: b.createInvokeHandler("editor.justifyCenter")
          }),
          m = f.button({
            contents: f.icon(h.icons.alignRight),
            tooltip: i.paragraph.right + l("justifyRight"),
            click: b.createInvokeHandler("editor.justifyRight")
          }),
          n = f.button({
            contents: f.icon(h.icons.alignJustify),
            tooltip: i.paragraph.justify + l("justifyFull"),
            click: b.createInvokeHandler("editor.justifyFull")
          }),
          o = f.button({
            contents: f.icon(h.icons.outdent),
            tooltip: i.paragraph.outdent + l("outdent"),
            click: b.createInvokeHandler("editor.outdent")
          }),
          p = f.button({
            contents: f.icon(h.icons.indent),
            tooltip: i.paragraph.indent + l("indent"),
            click: b.createInvokeHandler("editor.indent")
          });
        b.memo("button.justifyLeft", c.invoke(g, "render")), b.memo("button.justifyCenter", c.invoke(k, "render")), b.memo("button.justifyRight", c.invoke(m, "render")), b.memo("button.justifyFull", c.invoke(n, "render")), b.memo("button.outdent", c.invoke(o, "render")), b.memo("button.indent", c.invoke(p, "render")), b.memo("button.paragraph", function() {
          return f.buttonGroup([f.button({
            className: "dropdown-toggle",
            contents: f.icon(h.icons.align) + " " + f.icon(h.icons.caret, "span"),
          ...
          return f.button({
            ...
            tooltip: i.hr.insert + l("insertHorizontalRule"),
        ...
        for (var d = 0, e = c.length; e > d; d++) {
          for (var g = c[d], h = g[0], i = g[1], j = f.buttonGroup({
            ...
            m && j.append("function" == typeof m ? m() : m)
          }
          j.appendTo(a)
        }
        ...
        if (this.updateBtnStates({
          ...
          var e = c["font-family"].split(",").map(function(a) {
            ...
            f = d.find(e, function(a) {
              return j.isFontInstalled(a) || d.contains(h.fontNamesIgnoreCheck, a)
            });
          g.find(".dropdown-fontname li a").each(function() {
            var b = a(this).data("value") + "" == f + "";
            this.className = b ? "checked" : ""
          }), g.find(".note-current-fontname").text(f)
        }
        if (c["font-size"]) {
          var i = c["font-size"];
    ...
    ca = function(b) {
      ...
      this.initialize = function() {
        ...
        a.on("keypress", function(a) {
          a.keyCode === I.code.ENTER && b.trigger("click")
        })
    ...
    da = function(b) {
      ...
      this.events = {
        ...
        if (c.isCollapsed() && c.isOnAnchor()) {
          var d = m.ancestor(c.sc, m.isAnchor),
            e = a(d).attr("href");
          this.$popover.find("a").attr("href", e).html(e);
          var f = m.posFromPlaceholder(d);
          this.$popover.css({
            display: "block",
            left: f.left,
            top: f.top
    ...
    ia = function(b) {
      ...
      this.events = {
        ...
        "summernote.focusout": function(a, b) {
          j.isFF || b.relatedTarget && m.ancestor(b.relatedTarget, c.eq(e.$popover[0])) || e.hide()
        }
      }, this.shouldInitialize = function() {
    ...
    ja = function(b) {
      ...
      this.events = {
        ...
        if (a.length) {
          ...
          this.lastWordRange.insertNode(c), J.createFromNode(c).collapse().select(), this.lastWordRange = null, this.hide(), b.invoke("editor.focus")
        }
      }, this.nodeFromItem = function(a) {
        var b = j[a.data("index")],
          c = a.data("item"),
          d = b.content ? b.content(c) : c;
        return "string" == typeof d && (d = m.createText(d)), d
        ...
        this.$popover.is(":visible") && (a.keyCode === I.code.ENTER ? (a.preventDefault(), this.replace()) : a.keyCode === I.code.UP ? (a.preventDefault(), this.moveUp()) : a.keyCode === I.code.DOWN && (a.preventDefault(), this.moveDown()))
        ...
        if (d.contains([I.code.ENTER, I.code.UP, I.code.DOWN], a.keyCode)) {
          if (a.keyCode === I.code.ENTER && this.$popover.is(":visible")) return
        } else {
