			...
			try {
				...
				dt.buttons.info(
					...
					dt.i18n( 'buttons.copySuccess', {
							1: "Um item copiado para a área de transferência",
							_: "%d items copiados para a área de transferência"
						}, exportData.rows ),
					2000
				);
...
DataTable.ext.buttons.pdfHtml5 = {
    ...
    var __content = undefined;
    if (config.__page === 'report') {
      __content = [
        {
          text: config.__header.title + "\n\n",
          style: {
            fontSize: 12,
            alignment: 'left',
            bold: true
        ...
        {
          text: config.__header.report,
            style: { fontSize: 10 }
        },
        config.__header.items,
        {
          table: {
            headerRows: 1,
            body: rows
